...
describe("Space Figurate Numbers Generation", () => {
  it("should return the sequence of pyramidal numbers", () => {
    const generator = SpaceFigNumbers.generate("pyramidal", { step: 1, m: 18 });
  ...
  it("should return the sequence of centeredMgonalPyramidal numbers", () => {
    const generator = SpaceFigNumbers.generate("centeredMgonalPyramidal", { m: 11 });
    const arrOfFigNumbers = createArrOfFigNumbers(60, generator);
    expect(arrOfFigNumbers).toEqual([
  ...
  it("should return the sequence of centeredMgonalPyramid numbers", () => {
    const generator = SpaceFigNumbers.generate("centeredMgonalPyramid", { m: 9 });
    const arrOfFigNumbers = createArrOfFigNumbers(10, generator);
    expect(arrOfFigNumbers).toEqual([1, 11, 45, 119, 249, 451, 741, 1135, 1649, 2299]);
  });

  it("should return the sequence of octahedral numbers", () => {
    const generator = SpaceFigNumbers.generate("octahedral", {});
    const arrOfFigNumbers = createArrOfFigNumbers(10, generator);
    expect(arrOfFigNumbers).toEqual([1, 6, 19, 44, 85, 146, 231, 344, 489, 670]);
  });

  it("should return the sequence of centered dodecahedral numbers", () => {
    const generator = SpaceFigNumbers.generate("dodecahedral", {});
    const arrOfFigNumbers = createArrOfFigNumbers(75, generator);
    expect(arrOfFigNumbers).toEqual([
  ...
  it("should return the sequence of icosahedral numbers", () => {
    const generator = SpaceFigNumbers.generate("icosahedral", {});
    const arrOfFigNumbers = createArrOfFigNumbers(10, generator);
    expect(arrOfFigNumbers).toEqual([1, 12, 48, 124, 255, 456, 742, 1128, 1629, 2260]);
  });

  it("should return the sequence of stellaOctangula numbers", () => {
    const generator = SpaceFigNumbers.generate("stellaOctangula", {});
    const arrOfFigNumbers = createArrOfFigNumbers(10, generator);
    expect(arrOfFigNumbers).toEqual([1, 14, 51, 124, 245, 426, 679, 1016, 1449, 1990]);
  });

  it("should return the sequence of mgonalPrism numbers", () => {
    const generator = SpaceFigNumbers.generate("mgonalPrism", { m: 14 });
